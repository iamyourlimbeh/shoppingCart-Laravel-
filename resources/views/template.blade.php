                    ...
                    <div class="col-md-2">
                        ...
                        <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                      <a class="dropdown-item" href="comingsoon.html">Mountain Bike</a>
                                      <a class="dropdown-item" href="roadbike.html">Road Bike</a>
                                      <a class="dropdown-item" href="foldingbike.html">Folding Bike</a>
                                      <a class="dropdown-item" href="Dropdown-Bicycle.html">Other</a>
                                    </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-6" style="margin-top: 10px">
                                <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                          ...
                                          <li class="page-item"><a class="page-link" href="comingsoon.html">1</a></li>
