    ...
    <div class="container">
        ...
        @foreach($products as $product)
            ...
            <div class="preview text-center">
                <img class="preview-img" src="{{ asset('images/') }}/{{$product->image}}" alt="Preview Image" width="200" height="200"/>

                <input class="form-control" type="hidden" name="id" value="" />

                <div class="browse-button">
                    <i class="fa fa-pencil-alt"></i>
                    <input class="browse-input" type="file" required name="product-image" id="{{$product->id}}"/>
                </div>
